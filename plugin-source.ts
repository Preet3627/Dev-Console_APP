export const pluginSourceCode = [
  ...
  '        if (!get_option(DC_CORS_SETTINGS_OPTION)) { add_option(DC_CORS_SETTINGS_OPTION, [\'allow_all\' => false, \'allowed_origins\' => \'https://ai.ponsrischool.in\']); }',
  '    }',
  '',
  ...
  '                <?php',
  '                $options = get_option(DC_CORS_SETTINGS_OPTION, [\'allow_all\' => false, \'allowed_origins\' => \'https://ai.ponsrischool.in\']);',
  '                ?>',
  ...
  '                                <p class="description">Enter allowed domains, one per line (e.g., https://ai.ponsrischool.in, http://localhost:5173).</p>',
  '                            </td>',
  '                        </tr>',
  '                    </tbody>',
  '                </table>',
  ...
  '    }',
  '',
  '    private function action_ping($payload) { return [\'message\' => \'pong\']; }',
  '',
